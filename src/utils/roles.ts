...
/* ============================================================
   ...
   политики AdminOnly/Staff в AuthExtensions.cs; тонкие правила
   (удаление/статусы) дозакрываются эндпоинтами по тем же ролям.
   ...
   Локальный режим (user=null) — права администратора (单机-разработка).
   ============================================================ */
